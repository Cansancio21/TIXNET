...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2025 at 06:42 PM
...
(2, 'Modems', 'Deployment', 15, '2025-05-16'),
...
(0, '2025-05-17 00:33:47', 'user \"Latifah Sims\" has successfully logged in'),
(0, '2025-05-17 00:36:43', 'user \"Latifah Sims\" has successfully logged in'),
(0, '2025-05-17 00:39:57', 'user \"Latifah Sims\" has successfully logged in');
...
(16, 9, 'Sims', 'Latifah', 'ref#-07-04-2025-484929', 'Critical', 'awaw', 'Archived'),
...
(65, 'awaw', 'awawaw', 'awaww@gmail.com', 'tech12', '$2y$10$p7R729pNxVk/cmlLMMytGe2MY0uvbYtMxpGMSdO9MKOymz3pKCwkC', 'technician', 'active');
...
--
ALTER TABLE `tbl_borrowed`
  MODIFY `b_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
