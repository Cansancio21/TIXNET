...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2025 at 07:54 PM
...
(14, 'Fiber Optic Cable', 0, 'Tatyana Hayden', '2025-04-05', 37);
...
(5, 'Fiber Optic Cable', 'Borrowing', '2025-03-31', 30);
...
--
ALTER TABLE `tbl_borrowed`
  MODIFY `b_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_returned`
  MODIFY `r_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tbl_user`
  MODIFY `u_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
COMMIT;
