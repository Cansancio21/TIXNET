...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2025 at 11:08 PM
...
(15, 'Fiber Optic Cable', 0, 'Tatyana Hayden', '2025-04-10', 37);
...
--
ALTER TABLE `tbl_user`
  MODIFY `u_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
COMMIT;
