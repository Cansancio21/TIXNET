...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2025 at 05:53 AM
...
CREATE TABLE `tbl_assets` (
  ...
  `a_ref_no` int(100) NOT NULL,
  `a_serial_no` int(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_assets` (`a_id`, `a_name`, `a_status`, `a_quantity`, `a_date`, `a_ref_no`, `a_serial_no`) VALUES
(1, 'Ladder', 'Borrowing', 1, '2025-05-16', 0, 0),
(2, 'Modemsss', 'Archived', 9, '2025-05-16', 0, 0),
(3, 'Wire', 'Archived', 16, '2025-05-16', 0, 0),
(4, 'Fiber Optic Cables', 'Archived', 13, '2025-05-16', 0, 0),
(5, 'Example', 'Archived', 3, '2025-05-16', 0, 0),
(6, 'example', 'Deployment', 2, '2025-05-21', 0, 0),
(7, 'fiber', 'Deployment', 10, '2025-05-14', 0, 0),
(8, 'fiber', 'Borrowing', 10, '2025-05-18', 0, 0),
(9, 'example', 'Borrowing', 2, '2025-05-13', 0, 0),
(10, 'optic', 'Deployment', 5, '2025-05-13', 0, 0),
(11, 'example', 'Borrowing', 2, '2025-05-13', 0, 0),
(12, 'knife', 'Borrowing', 9, '2025-05-19', 0, 0),
(13, 'Tester', 'Borrowing', 5, '2025-05-19', 0, 0),
(14, 'optal', 'Borrowing', 5, '2025-05-10', 0, 0),
(15, 'fibrics', 'Borrowing', 7, '2025-05-21', 0, 0),
(16, 'Test', 'Deployment', 15, '2025-05-23', 0, 0);
...
INSERT INTO `tbl_customer` (`c_id`, `c_fname`, `c_lname`, `c_purok`, `c_barangay`, `c_contact`, `c_email`, `c_date`, `c_napname`, `c_napport`, `c_macaddress`, `c_status`, `c_plan`, `c_equipment`, `c_account_no`, `c_coordinates`, `c_balance`, `c_startdate`, `c_nextdue`, `c_lastdue`, `c_nextbill`, `c_billstatus`, `c_advancedays`) VALUES
(29, 'Lyle', 'Barr', 'Lance Heath', 'Deleniti dolore est', '25690765564', 'moluxonu@mailinator.com', '2025-05-24', 'Lp1 Np8', 5, 'Aconsecteturerror', 'Active', 'Plan 2500', 'Customer-Owned', 69037768, 'Reprehenderit atque', -10000, '2025-08-03', '2025-09-03', '', '2025-08-27', 'Active', '0'),
(30, 'David', 'Burns', 'Maris Ferguson', 'Aut nostrud veniam', '77445677712', 'demarexe@mailinator.com', '2025-05-24', 'Lp1 Np5', 7, 'AbNamomnisquisin123', 'Active', 'Plan 999', 'ISP-Provided Modem/Router', 85849371, '14.23245,562.67523', -1000, '2025-08-03', '2025-09-03', '', '2025-08-19', 'Active', '0'),
(31, 'Eve', 'Rosa', 'Aileen Colon', 'In et ut dolorem max', '802', 'darywyje@mailinator.com', '2025-05-24', 'Lp1 Np6', 4, 'PorroNamullamcosi', 'Active', 'Plan 1299', 'ISP-Provided Modem/Router', 52111545, 'Quasi a recusandae', 0, '2025-08-03', '2025-09-03', '', '2025-08-26', 'Active', '0'),
(32, 'John William', 'Mayormita', 'Purok Tambis', 'Banhigan', '09394578940', 'demarexe@mailinator.com', '2025-07-20', 'Lp1 Np2', 3, 'testing', 'Active', 'Plan 1499', 'ISP-Provided Modem/Router', 59993635, 'Reprehenderitatque', 1, '2025-08-06', '2025-09-06', '', '2025-08-30', 'Active', '0'),
(33, 'ryan', 'cansancio', 'tambis', 'ward', '0900909099', 'ryancansancio7@gmail.com', '2025-07-26', 'Lp1 Np6', 5, 'ward', 'Active', 'Plan 2500', 'ISP-Provided Modem/Router', 83775848, 'awawawaw', 500, '2025-08-03', '2025-09-03', '', '2025-08-27', 'Active', '0'),
(34, 'Mikha', 'Lim', 'Purok Wildflower', 'Pakigne', '09560390918', 'williammayormita69@gmail.com', '2025-08-14', 'Lp1 Np1', 4, 'Amzxksdn', 'Active', 'Plan 799', 'Customer-Owned', 31010041, '142.342.234.234', 1001, '2025-08-15', '2025-09-15', '', '2025-09-07', 'Active', '8'),
(35, 'Pham', 'Hanni', 'Curvada', 'Banhigan', '092345678918', 'williammayormita69@gmail.com', '2025-08-14', 'Lp1 Np1', 6, 'ahsshAJAJSDB', 'Active', 'Plan 1799', 'ISP-Provided Modem/Router', 48926186, '142.342.234.234', 201, '2025-08-15', '2025-09-15', '', '2025-09-07', 'Active', '8');
...
(22, 'Mikha Lim', 'no connection', 'Open', 'test', 'ref#-08-15-2025-468031', ''),
(23, 'John William Mayormita', 'no conncection', 'Open', 'test', 'ref#-08-15-2025-152225', ''),
...
(41, 'Kolehe', 'Kai', 'kolohekai@gmail.com', 'Kolohe', '$2y$10$p0uaBuH3RfB6BxHsbgIguevieEhZ9CplkIFXB50PetTP.0eFfmfkm', 'technician', 'active', 0),
...
(77, 'tech', 'admin', 'admin@gmail.com', 'techsss', '$2y$10$8ROUBP0Hkx6rcidFGZdGM.ZvzYMVZe0Z6lQNFtmfdGShBIhyF6p0G', 'technician', 'active', 0),
...
--
ALTER TABLE `tbl_ticket`
  MODIFY `t_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
