...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2026 at 06:27 AM
...
(103, 'TEST-001', 'Test', 'Deployment', 'Available', 1, 'SNJ-1728-SJ', 'example lang', 'Reusable', 'Good Condition', '2026-01-11');
...
(17, 'ROUTER-001', 'Router', 'Tatyana Hayden', 37, 'ADXGTVF123G', '2025-12-08', '2026-01-11', 'Returned'),
(18, 'ROUTER-001', 'Router', 'Tatyana Hayden', 37, 'ADXGTVF123G', '2026-01-11', '0000-00-00', 'Borrowed');
...
('2026-01-11 12:32:52', 'Staff Huh Jen', 'Staff Huh has successfully logged in'),
('2026-01-11 12:37:09', 'Staff Erzaa', 'Staff Erzaa added 1 asset(s) named \'Test\''),
('2026-01-11 13:04:44', 'Staff Erzaa', 'Staff Erzaa returned 1 asset(s)'),
('2026-01-11 13:05:43', 'Staff Erzaa', 'Staff Erzaa borrowed 1 asset(s) to technician Tatyana Hayden (ID: 37)');
...
--
ALTER TABLE `tbl_assets`
  MODIFY `a_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT for table `tbl_asset_status`
--
ALTER TABLE `tbl_asset_status`
  MODIFY `a_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
