...
<head>
    ...
    <link rel="stylesheet" href="PaymentsT.css">
...
<div class="wrapper">
    <div class="sidebar glass-container">
        ...
        <ul>
            ...
            <li><a href="Payments.php" class="active"><img src="image/transactions.png" alt="Payment Transactions" class="icon" /> <span>Payment Transactions</span></a></li>
        </ul>
        <footer>
...
function showTransactionViewModal(t_id, t_date, t_customer_name, t_credit_date, t_description, t_amount, t_balance) {
    const content = `
        ...
        <p><strong>Balance:</strong> ${t_balance}</p>
    `;
