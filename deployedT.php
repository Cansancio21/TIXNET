...
if (isset($_GET['action']) && $_GET['action'] === 'export_data') {
    ...
    if ($searchTerm !== '') {
        $whereClauses[] = "(a_ref_no LIKE ? OR a_name LIKE ? OR tech_name LIKE ? OR tech_id LIKE ? OR a_serial_no LIKE ? OR a_date LIKE ?)";
    ...
    $sqlExport = "SELECT a_id, a_ref_no, a_name, tech_name, tech_id, a_serial_no, a_date 
...
if (isset($_GET['action']) && $_GET['action'] === 'search' && isset($_GET['search'])) {
    ...
    $sql = "SELECT a_id, a_ref_no, a_name, tech_name, tech_id, a_serial_no, a_date 
...
if ($conn) {
    ...
    $assetNamesQuery = "SELECT DISTINCT a_name FROM tbl_asset_status WHERE a_status = 'Deployed' ORDER BY a_name";
    ...
    $technicianNamesQuery = "SELECT DISTINCT tech_name FROM tbl_asset_status WHERE a_status = 'Deployed' ORDER BY tech_name";
    ...
    $sqlBorrowed = "SELECT a_id, a_ref_no, a_name, tech_name, tech_id, a_serial_no, a_date 
                    FROM tbl_asset_status 
                    $whereClause 
                    ORDER BY a_date DESC 
                    LIMIT ?, ?";
...
<div class="wrapper">
    <div class="sidebar glass-container">
        ...
        <ul>
          ...
          <li><a href="deployedT.php" class="active"><i class="fas fa-box icon"></i> <span>Deployed Records</span></a></li>
